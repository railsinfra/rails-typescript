...
[![NPM version](<https://img.shields.io/npm/v/rails.svg?label=npm%20(stable)>)](https://npmjs.org/package/rails) ![npm bundle size](https://img.shields.io/bundlephobia/minzip/rails)
...
```sh
npm install git+ssh://git@github.com:sibabale/rails-typescript.git
```
