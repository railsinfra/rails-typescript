...
[![NPM version](<https://img.shields.io/npm/v/railsinfra.svg?label=npm%20(stable)>)](https://npmjs.org/package/railsinfra) ![npm bundle size](https://img.shields.io/bundlephobia/minzip/railsinfra)
...
```ts
import Rails from 'npm:railsinfra';
